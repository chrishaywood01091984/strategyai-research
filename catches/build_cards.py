...
<style>
  ...
  *{{box-sizing:border-box}}
  ...
  /* The lead-time badge is the whole point of the card, so it is sized to dominate the
     spine. Vertical budget between the label rows is 332-412, badge occupies 342-402. */
  ...
  /* Kept short so its lower edge clears the lead-time badge, which starts at 335 with its ring. */
